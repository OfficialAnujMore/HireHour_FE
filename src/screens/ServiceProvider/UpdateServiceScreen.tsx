    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <CustomInput
                ...
                onValueChange={(value) => setServiceDetails({ ...serviceDetails, title: value })}
            />
            <CustomInput
                label="Description"
                value={serviceDetails.description}
                placeholder="Enter description"
                onValueChange={(value) => setServiceDetails({ ...serviceDetails, description: value })}
            />
            <CustomInput
                label="Charges Per Hour"
                value={serviceDetails.chargesPerHour}
                placeholder="Enter charges"
                onValueChange={(value) => setServiceDetails({ ...serviceDetails, chargesPerHour: value })}
            />
            <CustomDropdown
                label="Select a category"
                options={CATEGORY}
                value={serviceDetails.category}
                onValueChange={(value) => setServiceDetails({ ...serviceDetails, category: value })}
            />
